<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="setpoker.aspx.cs" Inherits="JDWeb.setpoker" %>
...
<script src="js/mys_poker.js " type="text/javascript"> </script>
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-list">扑克牌配置</span>
                    </div>
                    	...
                    	<div class="mws-form">
                    		<div class="mws-form-inline">
                                ...
                                <div class="mws-form-row">
                    				<label>玩家数量</label>
                    				<div class="mws-form-item small">
                    					<select id="PlayerNum" style="float:left;">
                    				...
                    				<div class="mws-form-item large">
                                    	<div class="mws-dualbox clearfix">
                                            ...
                                            <div id="d1" style="float:left">
	                                            <span id="box1Counter" class="countLabel">玩家一 0 </span>
                                                <div style="display:block">
                                                    <input id="Button1" type="button" value="<<" />
                                                </div>
                                                <select id="box1View" multiple="multiple" style="height:260px;width:100px"></select>
                                                
                                            </div>

                                            <div id="d2" style="float:left">

                                                <span id="box2Counter" class="countLabel">玩家二 0 </span>
                                                <div style="display:block">
                                            ...
                                            <div id="d3" style="float:left">
                                                ...
                                                <span id="box3Counter" class="countLabel">玩家三 0 </span>
                                                <div style="display:block">
                                            ...
                                            <div id="d4" style="float:left">

                                                <span id="box4Counter" class="countLabel">玩家四 0 </span>
                                                <div style="display:block">
                                            ...
                                            <div id="d5" style="float:left">
                                                ...
                                                <span id="box5Counter" class="countLabel">玩家五 0 </span>
                                                <div style="display:block">
                                            ...
                                            <div id="d6" style="float:left">

                                                <span id="box6Counter" class="countLabel">玩家六 0 </span>
                                                <div style="display:block">
                                            ...
                                            <div id="d7" style="float:left">

                                                <span id="box7Counter" class="countLabel">玩家七 0 </span>
                                                <div style="display:block">
                                                    <input id="Button7" type="button" value="<<" />
                                                </div>
                                                <select id="box7View" multiple="multiple" style="height:260px;width:100px"></select>

                                            </div>

                                            <div id="d8" style="float:left">

                                                <span id="box8Counter" class="countLabel">玩家八 0 </span>
                                                <div style="display:block">
                                                    <input id="Button8" type="button" value="<<" />
                                                </div>
                                                <select id="box8View" multiple="multiple" style="height:260px;width:100px"></select>

                                            </div>
                                            <div id="d9" style="float:left">

                                                <span id="box9Counter" class="countLabel">牌堆 0 </span>
                                                <div style="display:block">
                                                    <input id="Button9" type="button" value="<<" />
                                                </div>
                                                <select id="box9View" multiple="multiple" style="height:260px;width:100px"></select>
