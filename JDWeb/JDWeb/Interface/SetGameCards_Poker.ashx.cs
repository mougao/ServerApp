...
{
    /// <summary>
    /// SetGameCards_Poker 的摘要说明
    /// </summary>
    public class SetGameCards_Poker : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string sql = string.Format("INSERT into card_configs_poker (GameType,Cards,`Status`,Remarks)VALUES('{0}','{1}',{2},'{3}')", gametype, cards, status, remarks);
