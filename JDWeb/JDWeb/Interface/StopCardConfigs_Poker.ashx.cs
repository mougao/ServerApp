...
{
    /// <summary>
    /// StopCardConfigs_Poker 的摘要说明
    /// </summary>
    public class StopCardConfigs_Poker : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string sql = string.Format("UPDATE card_configs_poker SET `Status`=0 WHERE `index`={0}", index);
